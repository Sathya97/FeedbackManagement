...
<?php
  ...
  if (isset($_POST['getvalue'])) {
    ...
    $email = mysql_real_escape_string($_POST['email']);
        ...
        $sql = "DELETE FROM signup WHERE email='$email' AND department='$department' AND designation='$designation'";
            ...
            <div class="inner-bg">
                <div class="container">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Enter the details to delete</h3>
                  ...
                  <option value="f">Faculty</option>
			                        ...
			                        <button type="submit" class="btn" name="getvalue">Delete!</button>
