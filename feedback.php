...
echo '<a href="student.php?action=back" class="btn ">back</a>';
?>
<!DOCTYPE html>
<html lang="en">
 ...
 <form role="form" method="post" class="login-form">
                         ...
                         <input type="email" name="email" placeholder="Enter the faculty email" class="form-username form-control" id="form-username" required>
