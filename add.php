  ...
  if (isset($_POST['getvalue'])) {
    ...
    $confirmpassword = mysql_real_escape_string($_POST['confirmpassword']);
     ...
     if($password == $confirmpassword) {
        ...
        $sql = "INSERT INTO signup(department,designation, email,password,confirmpassword) VALUES ('$department','$designation' ,'$email','$password','$confirmpassword')";
    ...
    if($designation == 'f'){
        echo "<script type='text/javascript'>alert('Faculty added successfully');</script>";
    }
}
}
            ...
            <div class="inner-bg">
                <div class="container">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Enter the details to add</h3>
                  ...
                  <div class="form-group">
			                        ...
			                        <button type="submit" class="btn" name="getvalue">Add!</button>
