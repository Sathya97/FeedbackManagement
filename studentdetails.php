    ...
    <body>
                    ...
                    <div class="row">
                      ...
                      <form name="search" method="post" action="">
                       ...
                       <div class="form-bottom">
                         ...
                         $sql = "SELECT * FROM signup WHERE designation='s' AND department='$search'";
     ...
     while($row=mysqli_fetch_array($result)) {
      echo "<tr>";
        ...
        echo "<td>";  echo'<img src="profile/'; echo $row['filename'] ; echo '" ';echo "</td>";
...
//session_start();
  ...
  //mysqli_select_db($link,"FacultySIET");
   ...
   //$Email=$_SESSION['email'];
      ...
      $sql = "SELECT * FROM signup WHERE designation='s'";
     $result = mysqli_query($db,$sql);
     echo "<center>";
     echo "<table border='1px'  > ";
     echo "<tr >";
